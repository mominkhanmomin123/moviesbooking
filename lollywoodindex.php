...
?>
    <div class="form-container mt-5">
        <h2 class="text-center my-3">Lollywood Movie details</h2>
  ...
  <button name="lsubmit" class="bg-danger fs-4 fw-bold my-3 form-control text-light">Upload</button>
</form>
    </div>
<h1 class="text-center my-5">Our Lollywood movies</h1>
  <div class='container d-flex flex-wrap justify-content-center'> 
    <?php
        include "./connection.php";
        $record = mysqli_query($connection, "SELECT * FROM `lollywood_movies`");
                  ...
                  <div class='card'>
                      ...
                      <div class='card-body'>
                          ...
                          <div class='d-flex justify-content-between'>
                              <a href='delete.php?lollywooddelete=$row[id]' class='btn btn-danger'>Delete</a>
                              <a href='update.php?lollywoodupdate=$row[id]' class='btn btn-warning'>Update</a>
                          </div>
                      </div>
                  </div>
              </div>
