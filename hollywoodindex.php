...
?>
    <div class="form-container mt-5">
        <h2 class="text-center my-3">Hollywood Movie details</h2>
  ...
  <button name="hsubmit" class="bg-danger fs-4 fw-bold my-3 form-control text-light">Upload</button>
</form>
    </div>
<h1 class="text-center my-5">Our Hollywood movies</h1>
                  ...
                  <div class='card'>
                      ...
                      <div class='card-body'>
                          ...
                          <div class='d-flex justify-content-between'>
                              <a href='delete.php?hollywooddelete=$row[id]' class='btn btn-danger'>Delete</a>
                              <a href='update.php?hollywoodupdate=$row[id]' class='btn btn-warning'>Update</a>
                          </div>
                      </div>
                  </div>
              </div>
