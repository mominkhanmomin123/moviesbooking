...
<div class="form-container animate__animated animate__fadeInDown">
        ...
        <form action="reviewconfirmation.php" method="post">
            <div class="mb-3">
              <label for="username" class="form-label">Username</label>
              <input type="text" name="username" class="form-control" id="reviewusername" required>
             
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label">Password</label>
              <input type="password" name="password" class="form-control" id="reviewPassword" required>
            </div>
